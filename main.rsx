<App>
  ...
  >
    <Navigation
      ...
      itemMode="static"
      retoolStorageFileId="2d492297-6425-402d-be59-6f452a265e87"
      ...
      style={{ ordered: [{ color: "#3170f9" }, { hoverText: "primary" }] }}
    >
      <Option
        id="7b517"
...
"
    ...
    <Text
      ...
      value="👋 **Bienvenue {{ current_user.firstName || 'friend' }}!**"
    ...
    <Image
      ...
      retoolStorageFileId="d5d74835-4a70-4538-a502-d34cf542169b"
